<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TP_List.aspx.cs" Inherits="WebAPP.Adm.TP_List" %>
        ...
        <asp:Repeater ID="repList" runat="server">
         ...
         <%--       <tr class="click">--%>
                <tr>
                    ...
                    <td><%# Eval("EndTime")%></td>
                    <td><a href='TP_Create.aspx?id=<%# Eval("ID") %>'>编辑</a>&nbsp;&nbsp;<a href='TP_Person.aspx?id=<%# Eval("ID") %>'>投票项</a>&nbsp;&nbsp;<a href='TP_Extract.aspx?id=<%# Eval("ID") %>'>导出</a></td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
        <tr>
